    ...
    : QWidget(parent)
{
    ...
    connect(newButton, &QPushButton::clicked, this, [this] {
        Q_EMIT bedTempChanged(sbBedTemp->value(), checkAndWait->isChecked());
    });
    ...
    connect(newButton, &QPushButton::clicked, this, [this] {
        Q_EMIT extTempChanged(sbExtruderTemp->value(), comboExtruderSelect->currentIndex(), checkAndWait->isChecked());
    });
